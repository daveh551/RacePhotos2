...
namespace RacePhotos2.App_Architecture.Services.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RacePhotos2.App_Architecture.Services.Data.HighwayDataContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            MigrationsDirectory = @"App_Architecture\Services\Data\Migrations";
            ContextKey = "RacePhotos2.App_Architecture.Services.Data.HighwayDataContext";
        }

        protected override void Seed(RacePhotos2.App_Architecture.Services.Data.HighwayDataContext context)
        {
